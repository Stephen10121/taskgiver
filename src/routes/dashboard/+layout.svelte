<script lang="ts">
    import homeImg from "$lib/assets/home.svg";
    import calendarImg from "$lib/assets/calendar.svg";
    import groupsImg from "$lib/assets/groups.svg";
    import addJobImg from "$lib/assets/addjob.svg";
